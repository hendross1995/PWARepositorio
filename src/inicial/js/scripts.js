...
function setAnimations(){
	$('.title, .social, .login-container').addClass('uk-active');
...
function removeAnimations(){
	$('.login-container, .title, .counter_days, .counter_hours, .counter_minutes, .counter_seconds, .social, .subtitile_wrapper, .counter_button').removeClass('uk-active');
}
...
/*$('.js_countdown').countdown('2018/12/31', function(e) {
