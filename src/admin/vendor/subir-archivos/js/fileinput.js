...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="scroll file-preview {class}">\n' +
                '    {close}' +
                '    <div class="{dropClass}">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeTitle: 'Eliminar vista previa del archivo',
                    uploadIcon: '<i class="fa fa-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Subir archivo',
                    uploadRetryIcon: '<i class="fa fa-redo"></i>',
                    uploadRetryTitle: 'Volver a cargar',
                    ...
                    indicatorNewTitle: 'Aún no ha subido',
                    indicatorSuccessTitle: 'Subido correcamente',
                    indicatorErrorTitle: 'Error al subir',
                    indicatorLoadingTitle: 'Cargando...'
                }
            };
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fa fa-caret-left fa-6x"></i>',
            next: '<i class="fa fa-caret-right fa-6x"></i>',
            toggleheader: '<i class="fa fa-arrows-alt-v"></i>',
            fullscreen: '<i class="fa fa-expand"></i>',
            borderless: '<i class="fa fa-expand-arrows-alt"></i>',
        ...
        progressThumbClass: "progress-bar bg-info progress-bar-info progress-bar-striped active progress-bar-animated",
        progressClass: "progress-bar bg-info progress-bar-info progress-bar-striped active progress-bar-animated",
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'Archivo "{name}" (<b>{size} KB</b>) es demasiado pequeño y debe ser más grande que <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño de carga permitido máximo de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debes seleccionar al menos <b>{n}</b> {files} para subir.',
        msgFilesTooMany: 'Número de archivos seleccionados para cargar <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>.',
        msgFileNotFound: '¡Archivo "{name}" no funciona!',
        msgFileSecured: 'Las restricciones de seguridad impiden leer el archivo "{name}".',
        msgFileNotReadable: 'Archivo "{name}" no es legible.',
        msgFilePreviewAborted: 'La vista previa del archivo abortó para "{name}".',
        msgFilePreviewError: 'Se produjo un error al leer el archivo "{name}".',
        msgInvalidFileName: 'Caracteres no válidos o no admitidos en el nombre del archivo "{name}".',
        msgInvalidFileType: 'Tipo incorrecto para archivo "{name}". Solo "{types}" archivos son compatibles.',
        msgInvalidFileExtension: 'Extensión incorrecta para el archivo "{name}". Solo "{extensions}" archivos son compatibles.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadAborted: 'La carga del archivo fue abortada',
        msgUploadThreshold: 'Procesando...',
        msgUploadBegin: 'Inicializando...',
        msgUploadEnd: 'Finalizado',
        msgUploadEmpty: 'No hay datos válidos disponibles para cargar.',
        ...
        msgFoldersNotAllowed: '¡Arrastrar y soltar solo archivos! {n} carpeta(s) caído fueron salteados.',
        msgImageWidthSmall: 'Ancho del archivo de imagen "{name}" al menos debe ser {size} px.',
        msgImageHeightSmall: 'Alto del archivo de imagen "{name}" al menos debe ser {size} px.',
        msgImageWidthLarge: 'Ancho del archivo de imagen "{name}" no puede exceder {size} px.',
        msgImageHeightLarge: 'Alto del archivo de imagen "{name}" no puede exceder {size} px.',
        msgImageResizeError: 'No se pudo obtener el tamaño de las dimensiones de la imagen.',
        msgImageResizeException: 'Error al cambiar el tamaño de la imagen.<pre>{errors}</pre>',
        msgAjaxError: 'Algo salió mal con la operación {operation}. Por favor, ¡inténtelo de nuevo más tarde!',
        msgAjaxProgressError: '{operation} ha fallado',
        ajaxOperations: {
            deleteThumb: 'Eliminar archivo',
            uploadThumb: 'Subir archivo',
            uploadBatch: 'Cargar archivos por lotes',
            uploadExtra: 'Cargar datos de formulario'
        },
        dropZoneTitle: 'Arraste y suelte archivos aquí &hellip;',
        dropZoneClickTitle: '<br>(o clic para seleccionar {files})',
        previewZoomButtonTitles: {
            prev: 'Ver archivo anterior',
            next: 'Ver archivo siguiente',
            toggleheader: 'Alterner encabezado',
            fullscreen: 'Alterner pantalla completa',
            borderless: 'Alterner el modo sin bordes',
