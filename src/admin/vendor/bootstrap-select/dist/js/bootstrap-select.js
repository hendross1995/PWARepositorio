...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? 'Límite alcanzado ({n} elemento máximo)' : 'Límites alcanzados ({n} elementos máximos)',
        (numGroup == 1) ? 'Límite de grupo alcanzado ({n} elemento máximo)' : 'Límite de grupos alcanzados ({n} elementos máximos)'
      ];
    },
